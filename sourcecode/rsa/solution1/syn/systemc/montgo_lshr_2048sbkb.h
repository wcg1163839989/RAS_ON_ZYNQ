...
// ==============================================================
#ifndef __montgo_lshr_2048sbkb__HH__
#define __montgo_lshr_2048sbkb__HH__
#include "ACMP_lshr.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(montgo_lshr_2048sbkb) {
    ...
    SC_CTOR(montgo_lshr_2048sbkb):  ACMP_lshr_U ("ACMP_lshr_U") {
        ACMP_lshr_U.clk(clk);
