...
// ==============================================================
#ifndef __montgo_lshr_2050ng8j__HH__
#define __montgo_lshr_2050ng8j__HH__
#include "ACMP_lshr.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(montgo_lshr_2050ng8j) {
    ...
    SC_CTOR(montgo_lshr_2050ng8j):  ACMP_lshr_U ("ACMP_lshr_U") {
        ACMP_lshr_U.clk(clk);
