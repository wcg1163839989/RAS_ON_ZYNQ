...
entity montgo_lshr_2050ng8j is
    generic (
      ID : INTEGER := 1;            --core ID, unused in RTL
      din0_WIDTH : INTEGER := 2050;  --data bitwidth
      din1_WIDTH : INTEGER := 2050;    --shift control bitwidth
      dout_WIDTH : INTEGER := 2050;  --output bitwidth
      OP : INTEGER := 1;            --opcode: 0-shl, 1-lshr, 2-ashr
      NUM_STAGE : INTEGER := 7      --stage number
  );
    port (
      clk : IN STD_LOGIC;
      reset : IN STD_LOGIC;
...
end entity montgo_lshr_2050ng8j;
architecture rtl of montgo_lshr_2050ng8j is
