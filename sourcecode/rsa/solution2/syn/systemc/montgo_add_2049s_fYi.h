...
// ==============================================================
#ifndef __montgo_add_2049s_fYi__HH__
#define __montgo_add_2049s_fYi__HH__
#include "ACMP_add.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(montgo_add_2049s_fYi) {
    ...
    SC_CTOR(montgo_add_2049s_fYi):  ACMP_add_U ("ACMP_add_U") {
        ACMP_add_U.clk(clk);
